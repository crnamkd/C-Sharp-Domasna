...
using ExrciseClass7.Classes;

namespace ExrciseClass7
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Person Tomas = new Person("Tomas", "Jovanov", 26, Genre.Rock);
            ...
            //Maria
            Maria.FavoriteSongs = (from song in Songs
                                   where song.Genre == Genre.Classical
                                   select song).ToList();
            Maria.GetFavSongs();
            Console.WriteLine();

            //Stefan
            Stefan.FavoriteSongs = (from song in Songs
                                    where song.Genre == Genre.Techno
                                    select song).ToList();
            Stefan.GetFavSongs();
            Console.WriteLine();
            ...
            //Tomas
            Tomas.FavoriteSongs = (from song in Songs
                                   where song.Genre == Genre.Rock
                                   select song).ToList();
            Tomas.GetFavSongs();
